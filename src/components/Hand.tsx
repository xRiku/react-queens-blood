    ...
    <div className="flex w-full items-center justify-center py-8">
      <div className="flex flex-row gap-3 w-10/12">
        {hand.cards.map((card, index) => (
          <div
            className={`border-2 border-solid shadow-lg rounded-lg cursor-pointer ${selectedCard?.name === card.name ? 'border-green-400 -translate-y-8 transform ' : 'border-black'} h-72 w-60
